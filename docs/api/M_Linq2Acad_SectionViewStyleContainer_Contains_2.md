# SectionViewStyleContainer.Contains Method (string)
...
### Return Value
Type: bool<br />true if the source sequence contains an SectionViewStyle that has the specified name; otherwise, false.
<a href="#SectionViewStyleContainerContains-Method-string">Back to Top</a>
