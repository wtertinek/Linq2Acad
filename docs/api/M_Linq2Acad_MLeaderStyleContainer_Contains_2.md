# MLeaderStyleContainer.Contains Method (string)
...
### Return Value
Type: bool<br />true if the source sequence contains an MLeaderStyle that has the specified name; otherwise, false.
<a href="#MLeaderStyleContainerContains-Method-string">Back to Top</a>
