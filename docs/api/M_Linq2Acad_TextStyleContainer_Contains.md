# TextStyleContainer.Contains Method (ObjectId)
...
### Return Value
Type: bool<br />true if the source sequence contains an TextStyleTableRecord that has the specified ID; otherwise, false.
<a href="#TextStyleContainerContains-Method-ObjectId">Back to Top</a>
