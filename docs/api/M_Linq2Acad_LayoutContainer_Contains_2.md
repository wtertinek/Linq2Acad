# LayoutContainer.Contains Method (string)
...
### Return Value
Type: bool<br />true if the source sequence contains an Layout that has the specified name; otherwise, false.
<a href="#LayoutContainerContains-Method-string">Back to Top</a>
