# ViewportContainer.Contains Method (ObjectId)
...
### Return Value
Type: bool<br />true if the source sequence contains an Viewport that has the specified ID; otherwise, false.
<a href="#ViewportContainerContains-Method-ObjectId">Back to Top</a>
