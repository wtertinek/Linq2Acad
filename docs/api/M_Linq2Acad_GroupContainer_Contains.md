# GroupContainer.Contains Method (ObjectId)
...
### Return Value
Type: bool<br />true if the source sequence contains an Group that has the specified ID; otherwise, false.
<a href="#GroupContainerContains-Method-ObjectId">Back to Top</a>
