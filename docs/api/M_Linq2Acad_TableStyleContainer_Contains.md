# TableStyleContainer.Contains Method (ObjectId)
...
### Return Value
Type: bool<br />true if the source sequence contains an TableStyle that has the specified ID; otherwise, false.
<a href="#TableStyleContainerContains-Method-ObjectId">Back to Top</a>
