# RegAppContainer.Contains Method (string)
...
#### Return Value
Type: bool<br />true if the source sequence contains an RegAppTableRecord that has the specified name; otherwise, false.
