# ViewportContainer.Contains Method (string)
...
### Return Value
Type: bool<br />true if the source sequence contains an Viewport that has the specified name; otherwise, false.
<a href="#ViewportContainerContains-Method-string">Back to Top</a>
