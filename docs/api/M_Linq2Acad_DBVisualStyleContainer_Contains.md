# DBVisualStyleContainer.Contains Method (ObjectId)
...
### Return Value
Type: bool<br />true if the source sequence contains an DBVisualStyle that has the specified ID; otherwise, false.
<a href="#DBVisualStyleContainerContains-Method-ObjectId">Back to Top</a>
