# LinetypeContainer.Contains Method (ObjectId)
...
### Return Value
Type: bool<br />true if the source sequence contains an LinetypeTableRecord that has the specified ID; otherwise, false.
<a href="#LinetypeContainerContains-Method-ObjectId">Back to Top</a>
