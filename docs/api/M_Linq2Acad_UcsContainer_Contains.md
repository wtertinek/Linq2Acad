# UcsContainer.Contains Method (ObjectId)
...
### Return Value
Type: bool<br />true if the source sequence contains an UcsTableRecord that has the specified ID; otherwise, false.
<a href="#UcsContainerContains-Method-ObjectId">Back to Top</a>
